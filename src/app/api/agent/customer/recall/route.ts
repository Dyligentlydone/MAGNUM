...
export async function POST(req: NextRequest) {
    ...
    if (data && data.length > 0) {
        ...
        let greetingSuggestion = `Thank you for calling Magnum, this is Diligent! Hey ${customerName}! Great to hear from you again.`;
        if (vehicle) {
    ...
    try {
        ...
        const greetingSuggestion = `Thank you for calling Magnum, this is Diligent! How's it going ${firstName}, what can I help you with today?`;
