  ...
  return (
    <div className="px-4 py-3">
      <div className="grid grid-cols-12 gap-3 text-sm">
        ...
        <div className="col-span-2">{item.repairOrder.service_type || '—'}</div>
        <div className="col-span-3 flex items-center justify-end gap-2">
          {item.customer?.phone && (
            <button
              className="rounded-full border border-[#D4AF37]/35 bg-[#D4AF37]/15 px-3 py-1.5 text-sm font-semibold text-[#F6E7B7] backdrop-blur hover:bg-[#D4AF37]/22 active:bg-[#D4AF37]/28"
