...
```
https://magnumtire.up.railway.app/api/webhooks/zoho/repair-order-updated
```
...
2. **Create New Webhook**
   ...
   - URL to Notify: `https://magnumtire.up.railway.app/api/webhooks/zoho/repair-order-updated`
   - Method: `POST`
